...
## {{ "2019-01-31" | date: dateFormat }}
- gta5 scripting

## {{ "2019-01-30" | date: dateFormat }}
- Developing Breathing Sensor - Testing platform

## {{ "2019-01-29" | date: dateFormat }}
- Developing Breathing Sensor - Testing platform
- Low pass filter design

## {{ "2019-01-28" | date: dateFormat }}
- Developing Breathing Sensor - Testing platform

## {{ "2019-01-28" | date: dateFormat }}
- Developing Breathing Sensor - Testing platform

## {{ "2019-01-27" | date: dateFormat }}
- NULL
...
## {{ "2019-01-24" | date: dateFormat }}
- Developing Breathing Sensor - Testing platform

## {{ "2019-01-23" | date: dateFormat }}
- Developing Breathing Sensor - Testing platform

## {{ "2019-01-22" | date: dateFormat }}
...
## {{ "2018-12-31" | date: dateFormat }}
- NULL

## {{ "2018-12-30" | date: dateFormat }}
- NULL

## {{ "2018-12-29" | date: dateFormat }}
- NULL

## {{ "2018-12-28" | date: dateFormat }}
- NULL
...
## {{ "2018-12-25" | date: dateFormat }}
- NULL

## {{ "2018-12-24" | date: dateFormat }}
- NULL

## {{ "2018-12-23" | date: dateFormat }}
- NULL

## {{ "2018-12-22" | date: dateFormat }}
- Learning automation using tasker app
...
## {{ "2018-12-16" | date: dateFormat }}
- NULL

## {{ "2018-12-15" | date: dateFormat }}
- NULL
...
## {{ "2018-12-12" | date: dateFormat }}
- GIAN course on Autism and Assisted Technologies, Day-3

## {{ "2018-12-11" | date: dateFormat }}
- GIAN course on Autism and Assisted Technologies, Day-2

## {{ "2018-12-10" | date: dateFormat }}
- GIAN course on Autism and Assisted Technologies, Day-1

## {{ "2018-12-09" | date: dateFormat }}
- NULL

## {{ "2018-12-08" | date: dateFormat }}
- NULL

## {{ "2018-12-07" | date: dateFormat }}
- NULL
